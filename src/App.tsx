...
const StepAI = lazy(() => import('./pages/StepAI'));
const BrandingPage = lazy(() => import('./pages/services/BrandingPage'));
const DevelopmentPage = lazy(() => import('./pages/services/DevelopmentPage'));
...
const WheelManager = lazy(() => import('./pages/admin/WheelManager'));
...
const ClientAppointments = lazy(() => import('./pages/portal/ClientAppointments'));
const PortalApps = lazy(() => import('./pages/portal/PortalApps'));
...
const BrandConsultant = lazy(() => import('./pages/portal/BrandConsultant'));
const ProductGen = lazy(() => import('./components/dashboard/ProductGen'));
const LogoGen = lazy(() => import('./components/dashboard/LogoGen'));
const AppWrapper = lazy(() => import('./components/dashboard/AppWrapper'));
